...
options.add_extension("/Users/rachitbansal/Downloads/instagram_stgermain/extension.crx")
...
username.clear()
username.send_keys("confessions_pec")
password.clear()
password.send_keys("PeCCON22@")
...
for i,account in enumerate(to_get_followers):
    ...
    try:
        ...
        time.sleep(10)
        try:
            os.system('mv /Users/rachitbansal/Downloads/{}_followers.csv /Users/rachitbansal/Downloads/instagram_stgermain/accounts'.format(account))
        except:
